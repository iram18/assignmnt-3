    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_equal: {
                ...
                // here we setting up things for our random color generator
                // first we need to get length , because we need to know that we r trying to get color between our limit or not
